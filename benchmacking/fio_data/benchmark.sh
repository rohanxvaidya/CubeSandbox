...
VM_catch_top=0
CTEST_PATH=/home/wsf_test_0118/build/workload/Edge-Ceph-VirtIO
# TIME_H=8   #UTC 8点
# TIME_d=26  #UTC 26号
...
#   start  code   #############
ssh root@$NODE1 'sudo cpupower frequency-set -g performance' && ssh root@$NODE2 'sudo cpupower frequency-set -g performance' && ssh root@$NODE3 'sudo cpupower frequency-set -g performance'
...
# TEST_OPERATION=random_read 
  ...
  CHECK_CEPH_STATUS=$CHECK_CEPH_STATUS TEST_DURATION=$TEST_DURATION TEST_RAMP_TIME=$TEST_RAMP_TIME ctest -R test_edge_ceph_virtio_block_${TEST_OPERATION} -V -E pkm
