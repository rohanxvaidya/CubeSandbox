...
export TGT_ADDR="192.168.122.6,192.168.123.6,192.168.124.6,192.168.125.6"
...
function perf_data() {
    ...
    # sleep 60
    ssh -l ${user} ${IP} /root/mz/perf_analysis/perfmon.sh $1 $2 $3 &
}
