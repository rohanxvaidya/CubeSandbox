...
test_target_core_list=(1 2 3 4 5 6 7)  # storage target cpu core
...
drvie_connection_count=16  #8
#export TEST_BLOCK_SIZE=16  # default is 4k
export TEST_IO_DEPTH=1024
...
export TEST_JOBS_NUM=${TEST_JOBS_NUM:-2}
